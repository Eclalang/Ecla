...
func (t TypeOfStmt) StartLine() int {
	return t.TypeOfToken.Line
}

func (t TypeOfStmt) EndLine() int {
	return t.RightParen.Line
}
...
func (e EvalStmt) StartLine() int {
	return e.EvalToken.Line
}

func (e EvalStmt) EndLine() int {
	return e.RightParen.Line
}
...
func (l LenStmt) StartLine() int {
	return l.LenToken.Line
}

func (l LenStmt) EndLine() int {
	return l.RightParen.Line
}
...
func (s SizeofStmt) StartLine() int {
	return s.SizeofToken.Line
}

func (s SizeofStmt) EndLine() int {
	return s.RightParen.Line
}
...
func (a AppendStmt) StartLine() int {
	return a.AppendToken.Line
}

func (a AppendStmt) EndLine() int {
	return a.RightParen.Line
}
