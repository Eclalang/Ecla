...
func TestMulFloatString(t *testing.T) {
	t1 := Float(2)
	t2 := String("hello")
...
func TestFloatGetString(t *testing.T) {
	t1 := Float(0)
	t2 := String("0")
...
func TestFloatAndErr(t *testing.T) {
	...
	_, err := t1.And(t2)
	if err == nil {
		t.Error("Expected error when checking Float and string")
	}
}
...
func TestFloatOrErr(t *testing.T) {
	...
	_, err := t1.Or(t2)
	if err == nil {
		t.Error("Expected error when checking Float or string")
	}
}
...
func TestFloatXorErr(t *testing.T) {
	...
	_, err := t1.Xor(t2)
	if err == nil {
		t.Error("Expected error when checking Float xor string")
	}
}

func TestFloatLenErr(t *testing.T) {
	t1 := Float(5)

	_, err := t1.Len()
	if err == nil {
		t.Error("Expected error when checking len of Float")
	}
}

func TestDivEcFloatFloatErr(t *testing.T) {
	t1 := Float(5)
	t2 := Float(2)
...
func TestFloatGetIndexErr(t *testing.T) {
	...
	_, err := t1.GetIndex(Float(0))
	if err == nil {
		t.Error("Expected error when indexing")
	}
}

func TestAddFloatErr(t *testing.T) {
	t1 := Float(0)
	t2 := Bool(true)

	_, err := t1.Add(t2)
	if err == nil {
		t.Error("Expected error when adding a bool to an Float")
	}
}

func TestSubFloatErr(t *testing.T) {
	t1 := Float(0)
	t2 := Bool(true)

	_, err := t1.Sub(t2)
	if err == nil {
		t.Error("Expected error when subtracting a bool to an Float")
	}
}

func TestMulFloatErr(t *testing.T) {
	t1 := Float(0)
	t2 := Bool(true)

	_, err := t1.Mul(t2)
	if err == nil {
		t.Error("Expected error when multiplying an Float by a bool")
	}
}

func TestDivFloatErr(t *testing.T) {
	t1 := Float(0)
	t2 := Bool(true)

	_, err := t1.Div(t2)
	if err == nil {
		t.Error("Expected error when dividing an Float by a bool")
	}
}

func TestDivBy0FloatErr(t *testing.T) {
	t1 := Float(0)
	t2 := Float(0)

	_, err := t1.Div(t2)
	if err == nil {
		t.Error("Expected error when dividing an Float by 0")
	}
}

func TestDivBy0FloatCharErr(t *testing.T) {
	t1 := Float(5)
	t2 := Char(0)
...
func TestDivBy0FloatFloatErr(t *testing.T) {
	t1 := Float(5)
	t2 := Float(0)
...
func TestModFloatErr(t *testing.T) {
	...
	_, err := t1.Mod(t2)
	if err == nil {
		t.Error("Expected error when doing a modulo of an Float by a bool")
	}
}

func TestModBy0FloatErr(t *testing.T) {
	t1 := Float(1)
	t2 := Float(0)

	_, err := t1.Mod(t2)
	if err == nil {
		t.Error("Expected error when modding a Float by 0")
	}
}

func TestModBy0FloatCharErr(t *testing.T) {
	t1 := Float(1)
	t2 := Char(0)
